...
def sort_students_time_selection(students_list, order):
    '''
...
def sort_students_g_avg_insertion(student_list: list, order: str):
        """
...
def sort_students_failures_bubble(lst_students: list[dict], direction_order: str) -> list[dict]:
...
def sort(student_info: list, order: str, attribute: str) -> list:
    """Sorts the given list by the chosen order(Ascending/Descending) and by the chosen attribute(Age, StudyTime, Health, Failures) with bubble sorting technique
